...
var ImageType = styled3__default.default('svg')`
  width: 23px;
  height: 23px;
...
var Toastify = ({
  ...
  return /* @__PURE__ */ React2__default.default.createElement(
    ...
    /* @__PURE__ */ React2__default.default.createElement(
      ...
      /* @__PURE__ */ React2__default.default.createElement(
        ...
        /* @__PURE__ */ React2__default.default.createElement(
          ...
          /* @__PURE__ */ React2__default.default.createElement(SvgIcon, {
            color: 'gray',
            size: 25,
    ...
    /* @__PURE__ */ React2__default.default.createElement(Loader, {
      id,
      onAnimationEnd: funcDelete,
      property: toastStyle.autoClose,
    }),
    /* @__PURE__ */ React2__default.default.createElement(HiddenLoader, {
      style: { background: toastStyle.barColor },
    }),
  );
};
var GlobalStyle = styled3.createGlobalStyle`
* {
    margin: 0px;
    padding: 0px;
...
// src/Toast.tsx
var Toast2 = () => {
  const { toast, deleteToast } = React2.useContext(notifyContext);
  return /* @__PURE__ */ React2__default.default.createElement(
    styled3.ThemeProvider,
    { theme: themeStyle },
    /* @__PURE__ */ React2__default.default.createElement(GlobalStyle, null),
    typeof toast !== 'undefined'
      ? toast.map((el) =>
          /* @__PURE__ */ React2__default.default.createElement(Toastify, {
            deleteToast,
...
var NotifyProvider = ({ children, value }) => {
  return /* @__PURE__ */ React2__default.default.createElement(
    ...
    { value },
    /* @__PURE__ */ React2__default.default.createElement(Toast2, null),
    children,
  );
};
var useNotification = () => {
  const [id, setId] = React2.useState('0');
