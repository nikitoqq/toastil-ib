...
var Row = styled3__default.default("div")`
  ...
  padding: 0px 8px;
`;
var Loader = styled3__default.default("div")`
...
`;
var HiddenLoader = styled3__default.default(animationLoader)`
...
function Toastify({
  ...
  const [toastSetting, setToastSetting] = React2.useState({
    text,
    title,
  ...
  return /* @__PURE__ */ React2__default.default.createElement(Toast, { style: toastSetting }, /* @__PURE__ */ React2__default.default.createElement(Row, null, /* @__PURE__ */ React2__default.default.createElement(Column, null, /* @__PURE__ */ React2__default.default.createElement(Tittle, { property: toastSetting.h1 }, title)), /* @__PURE__ */ React2__default.default.createElement(CancelColumn, null, /* @__PURE__ */ React2__default.default.createElement(
    Cancel,
    {
      onClick: (e) => funcDelete(e.target),
      property: toastSetting.backgroundColor
    },
    /* @__PURE__ */ React2__default.default.createElement(SvgIcon_default, { id, color: "gray", size: 25, path: CANCEL_SVG_PATH })
  ))), /* @__PURE__ */ React2__default.default.createElement(Row, null, /* @__PURE__ */ React2__default.default.createElement(Column, null, /* @__PURE__ */ React2__default.default.createElement(SvgIcon_default, { color: toastSetting.iconColor, path: toastSetting.type }), /* @__PURE__ */ React2__default.default.createElement(Message, { property: toastSetting.h2 }, text))), /* @__PURE__ */ React2__default.default.createElement(Loader, { property: toastSetting.barColor }, /* @__PURE__ */ React2__default.default.createElement(
    HiddenLoader,
    {
      id,
...
function Toast2({ notifyContext: notifyContext2 }) {
  ...
  return /* @__PURE__ */ React2__default.default.createElement(styled3.ThemeProvider, { theme: themeStyle }, /* @__PURE__ */ React2__default.default.createElement(globalStyle_default, null), PORTAL_CLASS.map(
    (pos) => toast ? reactDom.createPortal(
      toast.map(
        (el) => pos === el.position ? /* @__PURE__ */ React2__default.default.createElement(
          Toastify,
          {
            deleteToast,
